<template>
    <div class="bg-white px-5 py-2 rounded">
        ...
        <!-- TODO boton para agregar producto -->
        <!-- component -->
...
import { getProductsAction } from '@/modulos/products/actions';
import ButtonPagination from '@/modulos/common/components/ButtonPagination.vue';
import { usePagination } from '@/modulos/common/composables/usePagination';
