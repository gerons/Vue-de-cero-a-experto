    ...
    <form @submit="onSubmit" class="grid grid-cols-1 sm:grid-cols-2 bg-white px-5 gap-5">
      ...
      <div class="first-col">
        ...
        <div class="mb-4">
          ...
          <select v-model="gender" v-bind="genderAttrs" :class="['form-control', { 'border-red-500': errors.gender }]">
            <option value="">Seleccione</option>
            <option value="kid">Niño</option>
            <option value="women">Mujer</option>
            <option value="men">Hombre</option>
          </select>
          <span v-if="errors.gender" class="text-red-400 text-xs">{{ errors.gender }}</span>
        </div>
        <!-- Botón para guardar -->
